...
public class DictionaryTester {
    ...
    public static void main(String [] args) {
        ...
        System.out.println("Testing the Array with randomly ordered data...\n"); 
        ...
        System.out.println("Now performing " + (1000) +
               " searches.");
        start = System.currentTimeMillis();
        for(int i=0; i < 1000; i++) {
        ...
        System.out.println("Reverse lookups...");
        System.out.println("Now performing " + (1000/10) +
               " searches.");
        start = System.currentTimeMillis();
